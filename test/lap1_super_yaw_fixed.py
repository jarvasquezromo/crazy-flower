...
class Surveyer:
    ...
    def _advance_mapping_radius(self):
        ...
        self.height_offset = np.random.uniform(-0.4, 0.4)
...
class FPVWindow(QtWidgets.QWidget):
    ...
    def _update_image(self, img):
        ...
        h, w, ch = rgb.shape
        q = QtGui.QImage(rgb.data, w, h, w * ch, QtGui.QImage.Format.Format_RGB888)
    ...
    def _ramp_setpoint(self, cmd, dt):
        ...
        yaw_step = float(np.clip(yaw_diff, -self._yaw_step_deg, self._yaw_step_deg))
